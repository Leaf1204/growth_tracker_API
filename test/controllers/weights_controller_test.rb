...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { dateOf: @weight.dateOf, value: @weight.value } }, as: :json
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { dateOf: @weight.dateOf, value: @weight.value } }, as: :json
    assert_response 200
  end
