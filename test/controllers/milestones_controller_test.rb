...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post milestones_url, params: { milestone: { dateOf: @milestone.dateOf, note: @milestone.note, weight: @milestone.weight } }, as: :json
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { dateOf: @milestone.dateOf, note: @milestone.note, weight: @milestone.weight } }, as: :json
    assert_response 200
  end
